CLASS zcl_renting_load_data_a02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_a02 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:   lt_brands       TYPE TABLE OF   zrent_brands_a02,
            lt_cars         TYPE TABLE OF   zrent_cars_a02,
            lt_customers    TYPE TABLE OF   zrent_custom_a02.
*    BRANDS
    lt_brands = VALUE #(
    ...
    INSERT zrent_brands_a02 FROM TABLE @lt_brands.
    SELECT * FROM zrent_brands_a02 INTO TABLE @lt_brands.
    out->write( sy-dbcnt ).
    out->write( 'zrent_brands_a02 data inserted successfully!' ).

*    CARS
    lt_cars = VALUE #(
        ( matricula = '1246GSA' marca = 'BMW'       modelo = 'SERIE 4'          color = 'BLANCO'    motor = '2.5' potencia = '210' und_potencia = 'CV' combustible = 'GASOLINA'
            consumo = '7.00'    fecha_fabr = '20200418' puertas = '5' precio = '210' moneda = 'USD' alquilado = 'X' alq_desde = '20241201' alq_hasta = '20241231' )
        ( matricula = '2174FHF' marca = 'KIA'       modelo = 'CEE''D'           color = 'AZUL'      motor = '4.2' potencia = '340' und_potencia = 'CV' combustible = 'GASOLINA'
            consumo = '10.00'   fecha_fabr = '20200617' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20230801' alq_hasta = '20230831' )
        ( matricula = '2356FSF' marca = 'AUDI'      modelo = 'A8'               color = 'BLANCO'    motor = '3.9' potencia = '140' und_potencia = 'CV' combustible = 'ELECTRIC'
            consumo = '00.00'   fecha_fabr = '20200304' puertas = '3' precio = '140' moneda = 'USD' alquilado = 'X' alq_desde = '20240701' alq_hasta = '20240708' )
        ( matricula = '2392JFH' marca = 'JEEP'      modelo = 'GRAND CHEROKEE'   color = 'BLANCO'    motor = '3.6' potencia = '176' und_potencia = 'CV' combustible = 'GASOLINA'
            consumo = '12.00'   fecha_fabr = '20200924' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20230601' alq_hasta = '20231001' )
        ( matricula = '2837KFF' marca = 'MERCEDES'  modelo = 'CLASE B'          color = 'NEGRO'     motor = '2.0' potencia = '200' und_potencia = 'CV' combustible = 'GASOLINA'
            consumo = '7.00'    fecha_fabr = '20200726' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20230301' alq_hasta = '20240301' )
        ( matricula = '2837SUF' marca = 'MERCEDES'  modelo = 'CLASE C'          color = 'AMARILLO'  motor = '3.0' potencia = '220' und_potencia = 'CV' combustible = 'GASOLINA'
            consumo = '6.00'    fecha_fabr = '20200614' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde = '20241201' alq_hasta = '20241206' )
        ( matricula = '2847JGH' marca = 'HONDA'     modelo = 'CARENS'           color = 'NEGRO'     motor = '1.9' potencia = '180' und_potencia = 'CV' combustible = 'DIESEL'
            consumo = '5.00'    fecha_fabr = '20210716' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde = '20241201' alq_hasta = '20241206' )
        ( matricula = '29348KJ' marca = 'MINI'      modelo = 'CABRIO'           color = 'AMARILLO'  motor = '2.0' potencia = '240' und_potencia = 'CV' combustible = 'ELECTRIC'
            consumo = '0.00'    fecha_fabr = '20200812' puertas = '3' precio = '150' moneda = 'USD' alquilado = 'X' alq_desde = '20241106' alq_hasta = '20241206' )
        ).

    DELETE FROM zrent_cars_a02.
    INSERT zrent_cars_a02 FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_a02 INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).
    out->write( 'zrent_cars_a02 data inserted successfully!' ).
...
*    CUSTOMERS
    ...
    DELETE FROM zrent_custom_a02.
    INSERT zrent_custom_a02 FROM TABLE @lt_customers.
    SELECT * FROM zrent_custom_a02 INTO TABLE @lt_customers.
    out->write( sy-dbcnt ).
    out->write( 'zrent_custom_a02 data inserted succesfully!' ).
